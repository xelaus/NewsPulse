...
<header>
    ...
    <div id="legend">
        ...
        <div class="legend_row">
            ...
            <div class="legend_item">
                <div class="legend_color">
                    <img src="http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|00ffff">
                </div>
                <div class="legend_text">
                    <p>Russia</p>
                </div>
...
//    var pinImage = new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|" + pinColor);
    var infowindow = new google.maps.InfoWindow();
            ...
            for (var i = 0; i < latitudeArray.length; i++) {
                    ...
                    var pinColor = "909090";
                if (newsSource[i] == 'CNN' || newsSource[i] == 'Reuters' || newsSource[i] == 'NewYorkTimes' || newsSource[i] == 'BreakingNews' || newsSource[i] == 'FoxNews') {
                    pinColor = '5cd622';
                }
                else if (newsSource[i] == 'Independent' || newsSource[i] == 'BBCWorld' || newsSource[i] == 'TheEconomist' || newsSource[i] == 'Conflicts') {
                    pinColor = '1fabf0';
                }
                else if (newsSource[i] == 'HDNER' || newsSource[i] == 'Turkey') {
                    pinColor = 'CC3232';
                }
                ...
                else if (newsSource[i] == 'Russia Today' || newsSource[i] == 'RT') {
                    pinColor = '00ffff';
                }
                else if (newsSource[i] == 'The Australian' || newsSource[i] == 'SkyNewsAust') {
                    pinColor = '9B30FF';
                }
                else if (newsSource[i] == 'CBC News' || newsSource[i] == 'Global News') {
                    pinColor = 'E5F2FF';
                }
                else if (newsSource[i] == 'AJEnglish') {
                    pinColor = '3EA055';
                }
